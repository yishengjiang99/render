...
var FFT_js_1 = require("../fft-64bits/FFT.js");
var FFTSize = 1024;
...
var fftWorker = new Worker("fftworker.js", { type: "module" });
fftWorker.onerror = function (e) { return console.error; };
...
function run_sf2_smpl(sampleInfo, zone, smplData, midi) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        var sr, startloop, pitch, endloop, file, range, ctx, audb, abs, lpf, modEnvelope, volumeEnveope, releaseTime, scriptproc, rendJoin, ab, flnum, readoffset, abss;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    scriptproc = ctx.createScriptProcessor(FFTSize, 1, 1);
                    abs
